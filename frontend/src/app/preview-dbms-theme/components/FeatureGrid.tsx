      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
          <div className="flex flex-col gap-4 h-full">
            <div className="dbms-flat-card p-6 md:p-8 h-full">
              <h3 className="text-xl font-semibold mb-3">Algorithmic Precision</h3>
              <p className="dbms-text-muted text-sm max-w-md mb-6 leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs dbms-text-muted">Match Speed</div>
                </div>
                <div
                  className="p-4 rounded-lg border"
                  style={{
                ...
                >
                  ...
                  <div className="text-xs dbms-text-muted">Active Roles</div>
                </div>
              </div>
            </div>
            ...
            <div className="dbms-flat-card p-6 md:p-8 h-full">
              <div className="flex items-start gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="dbms-text-muted text-sm leading-relaxed mt-1">
                    Fresh, deduped engineering roles delivered daily with your match score so you can
                    apply faster.
                  </p>
                </div>
              </div>
              <div className="space-y-2 text-sm dbms-text-muted">
          ...
          <div className="dbms-neumorphic-card p-6 md:p-8 flex flex-col justify-between h-full">
            <div>
              <div
              ...
              <p className="dbms-text-muted text-sm leading-relaxed">
            ...
            >
              {["Resume polish", "Fit explanations", "Skill gap tips", "Interview prep"].map((item) => (
                <span
                  key={item}
                  className="rounded-lg px-3 py-2 border text-center dbms-text-muted"
                  style={{
                    background: "hsl(var(--surface-sunken))",
                    borderColor: "hsl(var(--border))",
                  }}
